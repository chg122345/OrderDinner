				...
				<table align="center" width="100%">
					...
					<tr>
						<td colspan="6" align="right">总计:
							...
							<label
								id="counter" class="allTotal" style="font-size:36px">${sessionScope.order.totalPrice}</label>
						</td>
					</tr>
					<tr>
						<td colspan="6" style="margin-left: 100px; text-align: center;"align="right">
							<input type="hidden" name="bId" value="">
							<input type="button" value="结账" class="btn_next" lang="${sessionScope.order.table.id}" onclick="callPay(this)" />
						</td>
					</tr>
				</table>
			</div>
